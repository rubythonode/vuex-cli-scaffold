...
module.exports = construct = (modulesDirectory, entityBlueprint) => {
  ...
  fs.readFile('./../lib/module.js', 'utf8', (error, module) => {
  ...
  fs.readFile('./../lib/state.js', 'utf8', (error, state) => {
    if (error) throw new Error(error)
  ...
  fs.readFile('./../lib/getters.js', 'utf8', (error, getters) => {
    if (error) throw new Error(error)
  ...
  fs.readFile('./../lib/mutations.js', 'utf8', (error, mutations) => {
    if (error) throw new Error(error)
  ...
  fs.readFile('./../lib/actions.js', 'utf8', (error, actions) => {
    if (error) throw new Error(error)
